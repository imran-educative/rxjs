...
// END: ws-make-checkbox

// START: ws-combine-checkbox
...
// END: ws-combine-checkbox

// START: ws-combine-both
combineLatest(
  settings$,
  stockStream$,
